...
```bash
curl -X GET \
    -G "http://localhost/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "http://localhost/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "http://localhost/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"corrupti","ip_address":"odio","latitude":"sint","longitude":"dignissimos"}'
...
```bash
curl -X POST \
    "http://localhost/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"eum","latitude":"et","longitude":"ea"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/holidays?location_id=1&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=et&follow_up_type=nostrum&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "http://localhost/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"non","schedule_type":"vel","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=sit&biz_name=fuga&mobile_num=10&contact_id=vitae&order_by=error&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "http://localhost/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"iure","mobile_name":"dicta","call_type":"call","start_time":"et","end_time":"perferendis","duration":"id"}]}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=1&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":583.4387669999999843639670871198177337646484375,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":149964266.300000011920928955078125,"total_card_slips":13,"total_cheques":14,"closing_note":"qui","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 1,
    "initial_amount": 583.4387669999999843639670871198177337646484375,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 149964266.300000011920928955078125,
    "total_card_slips": 13,
    "total_cheques": 14,
    "closing_note": "qui",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/contactapi?type=occaecati&name=laborum&biz_name=ipsam&mobile_num=7&contact_id=expedita&order_by=non&direction=unde&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"debitis","prefix":"sunt","first_name":"id","middle_name":"odit","last_name":"culpa","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"adipisci","address_line_2":"vero","city":"et","state":"possimus","country":"sit","zip_code":"saepe","customer_group_id":"et","contact_id":"nulla","dob":"2000-06-13","custom_field1":"et","custom_field2":"ipsam","custom_field3":"mollitia","custom_field4":"mollitia","email":"culpa","shipping_address":"nihil","position":"minima","opening_balance":0,"source_id":18,"life_stage_id":17,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "debitis",
    "prefix": "sunt",
    "first_name": "id",
    "middle_name": "odit",
    "last_name": "culpa",
    ...
    "address_line_1": "adipisci",
    "address_line_2": "vero",
    "city": "et",
    "state": "possimus",
    "country": "sit",
    "zip_code": "saepe",
    "customer_group_id": "et",
    "contact_id": "nulla",
    "dob": "2000-06-13",
    "custom_field1": "et",
    "custom_field2": "ipsam",
    "custom_field3": "mollitia",
    "custom_field4": "mollitia",
    "email": "culpa",
    "shipping_address": "nihil",
    "position": "minima",
    "opening_balance": 0,
    "source_id": 18,
    "life_stage_id": 17,
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"eos","prefix":"voluptatem","first_name":"soluta","middle_name":"odio","last_name":"nulla","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"eveniet","address_line_2":"et","city":"iure","state":"inventore","country":"ut","zip_code":"impedit","customer_group_id":"veniam","contact_id":"voluptate","dob":"2000-06-13","custom_field1":"illo","custom_field2":"quo","custom_field3":"illo","custom_field4":"voluptatibus","email":"dolorum","shipping_address":"at","position":"fuga","opening_balance":10.300000000000000710542735760100185871124267578125,"source_id":1,"life_stage_id":13,"assigned_to":[]}'
...
let body = {
    ...
    "contact_id": "voluptate",
    "dob": "2000-06-13",
    "custom_field1": "illo",
    "custom_field2": "quo",
    "custom_field3": "illo",
    "custom_field4": "voluptatibus",
    "email": "dolorum",
    "shipping_address": "at",
    "position": "fuga",
    "opening_balance": 10.300000000000000710542735760100185871124267578125,
    "source_id": 1,
    "life_stage_id": 13,
    "assigned_to": []
}
...
```bash
curl -X POST \
    "http://localhost/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":4,"card_number":"ea","card_holder_name":"est","card_transaction_number":"cum","card_type":"adipisci","card_month":"soluta","card_year":"nesciunt","card_security":"illo","transaction_no_1":"maiores","transaction_no_2":"quaerat","transaction_no_3":"provident","cheque_number":"suscipit","bank_account_number":"laborum","note":"consequatur"}'
...
let body = {
    "contact_id": 17,
    "amount": 453.1299999999999954525264911353588104248046875,
    "method": "cash",
    "paid_on": "2020-07-22 15:48:29",
    "account_id": 4,
    "card_number": "ea",
    "card_holder_name": "est",
    "card_transaction_number": "cum",
    "card_type": "adipisci",
    "card_month": "soluta",
    "card_year": "nesciunt",
    "card_security": "illo",
    "transaction_no_1": "maiores",
    "transaction_no_2": "quaerat",
    "transaction_no_3": "provident",
    "cheque_number": "suscipit",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=deserunt&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":700869914.4786322116851806640625,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":15,"expense_for":5,"contact_id":13,"expense_category_id":18,"expense_sub_category_id":13,"additional_notes":"optio","is_refund":0,"is_recurring":0,"recur_interval":14,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"ducimus","recur_repetitions":18,"payment":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":11,"card_number":"iusto","card_holder_name":"velit","card_transaction_number":"voluptatem","card_type":"aut","card_month":"minima","card_year":"in","card_security":"saepe","transaction_no_1":"est","transaction_no_2":"et","transaction_no_3":"ea","note":"aut","cheque_number":"error"}]}'
...
let body = {
    "location_id": 1,
    "final_total": 700869914.4786322116851806640625,
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "http://localhost/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":6963.077731524999762768857181072235107421875,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":2,"expense_for":17,"contact_id":4,"expense_category_id":18,"expense_sub_category_id":18,"additional_notes":"et","is_recurring":0,"recur_interval":20,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"repellendus","recur_repetitions":3,"payment":[]}'
...
let body = {
    "final_total": 6963.077731524999762768857181072235107421875,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 2,
    "expense_for": 17,
    "contact_id": 4,
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=recusandae&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense-categories" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/expense-categories"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/field-force?contact_id=rerum&assigned_to=earum&status=earum&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/field-force"
);
...
```bash
curl -X POST \
    "http://localhost/connector/api/field-force/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":18,"visit_to":"dolore","visit_address":"reiciendis","assigned_to":5,"visit_on":"2021-12-28 17:23:00","visit_for":"ut"}'
...
```bash
curl -X POST \
    "http://localhost/connector/api/field-force/update-visit-status/17" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"possimus","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"sed","photo":"commodi"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "possimus",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product?order_by=et&order_direction=nesciunt&brand_id=omnis&category_id=voluptas&sub_category_id=distinctio&location_id=1&selling_price_group=reiciendis&send_lot_detail=qui&name=facilis&sku=odio&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "order_by": "et",
    "order_direction": "nesciunt",
    "brand_id": "omnis",
    "category_id": "voluptas",
    "sub_category_id": "distinctio",
    "location_id": "1",
    "selling_price_group": "reiciendis",
    "send_lot_detail": "qui",
    "name": "facilis",
    "sku": "odio",
    "per_page": "10",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product/1?selling_price_group=aut&send_lot_detail=accusamus" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/product/1"
);

let params = {
    "selling_price_group": "aut",
    "send_lot_detail": "accusamus",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/variation/2?product_id=libero&location_id=1&brand_id=vel&category_id=modi&sub_category_id=iure&not_for_selling=sit&name=nostrum&sku=voluptates&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/variation/2"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell?location_id=1&contact_id=consequuntur&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=nihil&service_staff_id=nihil&shipping_status=ordered&source=ullam&only_subscriptions=repudiandae&send_purchase_details=consequatur&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/sell"
);
...
let params = {
    ...
    "send_purchase_details": "consequatur",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":7,"transaction_date":"2020-07-22 15:48:29","invoice_no":"distinctio","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":12,"discount_amount":10,"discount_type":"fixed","sale_note":"et","staff_note":"vero","commission_agent":7,"shipping_details":"Express Delivery","shipping_address":"inventore","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":14,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":6,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"sunt","recur_repetitions":14,"rp_redeemed":17,"rp_redeemed_amount":13.5,"types_of_service_id":9,"service_custom_field_1":"quis","service_custom_field_2":"earum","service_custom_field_3":"voluptatibus","service_custom_field_4":"dolorum","service_custom_field_5":"nam","service_custom_field_6":"accusantium","round_off_amount":11.5013950000000004791900209966115653514862060546875,"table_id":14,"service_staff_id":18,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":9,"note":"alias"}],"payments":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":10,"card_number":"sit","card_holder_name":"velit","card_transaction_number":"hic","card_type":"eos","card_month":"repellat","card_year":"dolore","card_security":"nulla","transaction_no_1":"quia","transaction_no_2":"eaque","transaction_no_3":"quis","bank_account_number":"et","note":"sunt","cheque_number":"et"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "sunt",
            "recur_repetitions": 14,
            "rp_redeemed": 17,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 9,
            "service_custom_field_1": "quis",
            "service_custom_field_2": "earum",
            "service_custom_field_3": "voluptatibus",
            "service_custom_field_4": "dolorum",
            "service_custom_field_5": "nam",
            "service_custom_field_6": "accusantium",
            "round_off_amount": 11.5013950000000004791900209966115653514862060546875,
            "table_id": 14,
            "service_staff_id": 18,
            "change_return": 0,
            "products": [
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell/55?send_purchase_details=nobis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/sell/55"
);

let params = {
    "send_purchase_details": "nobis",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X PUT \
    "http://localhost/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":4,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":19,"discount_amount":10,"discount_type":"fixed","sale_note":"mollitia","source":"tempora","staff_note":"qui","is_suspend":false,"commission_agent":4,"shipping_details":"Express Delivery","shipping_address":"inventore","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":6,"pay_term_number":7,"pay_term_type":"months","is_recurring":0,"recur_interval":14,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"possimus","recur_repetitions":7,"rp_redeemed":19,"rp_redeemed_amount":13.5,"types_of_service_id":2,"service_custom_field_1":"itaque","service_custom_field_2":"blanditiis","service_custom_field_3":"aut","service_custom_field_4":"excepturi","service_custom_field_5":"praesentium","service_custom_field_6":"quibusdam","round_off_amount":35099.5105489999987185001373291015625,"table_id":6,"service_staff_id":2,"change_return":0,"change_return_id":20,"products":[{"sell_line_id":7,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":11,"discount_amount":0,"discount_type":"percentage","sub_unit_id":9,"note":"fugit"}],"payments":[{"payment_id":5,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":7,"card_number":"voluptate","card_holder_name":"alias","card_transaction_number":"voluptatem","card_type":"sunt","card_month":"sint","card_year":"nisi","card_security":"ipsam","transaction_no_1":"esse","transaction_no_2":"ut","transaction_no_3":"unde","note":"maxime","cheque_number":"explicabo","bank_account_number":"ipsum"}]}'
...
let body = {
    ...
    "service_custom_field_1": "itaque",
    "service_custom_field_2": "blanditiis",
    "service_custom_field_3": "aut",
    "service_custom_field_4": "excepturi",
    "service_custom_field_5": "praesentium",
    "service_custom_field_6": "quibusdam",
    "round_off_amount": 35099.5105489999987185001373291015625,
    "table_id": 6,
    "service_staff_id": 2,
    "change_return": 0,
    "change_return_id": 20,
    ...
    "payments": [
        {
            ...
            "card_year": "nisi",
            "card_security": "ipsam",
            "transaction_no_1": "esse",
            "transaction_no_2": "ut",
            "transaction_no_3": "unde",
            "note": "maxime",
            "cheque_number": "explicabo",
            "bank_account_number": "ipsum"
        }
    ]
}
...
```bash
curl -X DELETE \
    "http://localhost/connector/api/sell/omnis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "http://localhost/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":12,"transaction_date":"2020-5-7 15:20:22","invoice_no":"maiores","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":18,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```json
{
    ...
    "staff_note": null,
    "round_off_amount": "0.0000",
    "final_total": 2.640000000000000124344978758017532527446746826171875,
    "expense_category_id": null,
    "expense_for": null,
    "commission_agent": null,
    "document": null,
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "http://localhost/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":5,"shipping_status":"ordered","delivered_to":"beatae"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/table?location_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/table"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/taxonomy?type=sed" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "http://localhost/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"minus","first_name":"rerum","last_name":"rerum","email":"eos","is_active":"labore","user_type":"voluptatem","crm_contact_id":10,"allow_login":false,"username":"ut","password":"qui","role":4,"access_all_locations":true,"location_permissions":[],"cmmsn_percent":"est","max_sales_discount_percent":"veritatis","selected_contacts":true,"selected_contact_ids":[],"dob":"iste","gender":"ipsam","marital_status":"fuga","blood_group":"et","contact_number":"et","alt_number":"necessitatibus","family_number":"qui","fb_link":"ut","twitter_link":"atque","social_media_1":"nobis","social_media_2":"distinctio","custom_field_1":"deleniti","custom_field_2":"est","custom_field_3":"maxime","custom_field_4":"quis","guardian_name":"asperiores","id_proof_name":"vitae","id_proof_number":"sunt","permanent_address":"deserunt","current_address":"tempore","bank_details":[{"account_holder_name":"dolor","account_number":"dolorum","bank_name":"unde","bank_code":"qui","branch":"eos","tax_payer_id":"fuga"}]}'
...
let body = {
    ...
    "cmmsn_percent": "est",
    "max_sales_discount_percent": "veritatis",
    ...
    "blood_group": "et",
    "contact_number": "et",
    "alt_number": "necessitatibus",
    "family_number": "qui",
    "fb_link": "ut",
    "twitter_link": "atque",
    "social_media_1": "nobis",
    "social_media_2": "distinctio",
    "custom_field_1": "deleniti",
    "custom_field_2": "est",
    "custom_field_3": "maxime",
    "custom_field_4": "quis",
    "guardian_name": "asperiores",
    "id_proof_name": "vitae",
    "id_proof_number": "sunt",
    "permanent_address": "deserunt",
    "current_address": "tempore",
    "bank_details": [
        {
            "account_holder_name": "dolor",
            "account_number": "dolorum",
            "bank_name": "unde",
            "bank_code": "qui",
            "branch": "eos",
            "tax_payer_id": "fuga"
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/user?service_staff=sit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/user"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/user/1"
);
...
```bash
curl -X POST \
    "http://localhost/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"expedita","new_password":"culpa"}'
...
```bash
curl -X POST \
    "http://localhost/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"ipsa"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/profit-loss-report?location_id=1&start_date=2018-06-25&end_date=2018-06-25&user_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/profit-loss-report"
);
...
```json
{
    "data": {
        ...
        "net_profit": 9675.95000000000072759576141834259033203125,
        "gross_profit": -11.550000000000000710542735760100185871124267578125,
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/notifications"
);
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/get-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
```javascript
const url = new URL(
    "http://localhost/connector/api/get-location"
);
